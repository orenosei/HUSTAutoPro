  ...
  return (
    <div className="grid place-items-end">
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-pink-600 to-blue-500 text-white py-3 rounded-lg hover:from-pink-700 hover:to-blue-600 transition-all flex items-center justify-center"
      >
